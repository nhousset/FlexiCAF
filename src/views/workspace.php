...
<ul class="nav nav-tabs" id="viewTabs" role="tablist">
  ...
  <?php else: ?>
      <!-- EVOLUTION : Refonte des onglets pour l'utilisateur simple -->
...
<div class="tab-content bg-white border border-top-0 p-3 rounded-bottom shadow-sm" id="viewTabsContent">
    ...
    <?php if ($isManager): ?>
    <!-- ========================================================================================= -->
    <!-- VUE 1 : CONSULTANT / MOIS (Manager uniquement) -->
    ...
    <!-- ========================================================================================= -->
    <!-- VUE DÉTAIL CONSULTANT (ou "Mon activité") -->
    <div class="tab-pane <?= !$isManager ? 'active' : '' ?>" id="vue-detail" role="tabpanel">
        ...
        <!-- Le graphique reste ici pour les Managers lorsqu'ils zooment sur un profil -->
    ...
    <?php if (!$isManager): ?>
    <!-- ========================================================================================= -->
    <!-- NOUVELLE VUE GRAPHIQUE ISOLÉE POUR UTILISATEUR SIMPLE -->
    ...
    <?php if ($isManager): ?>
    <!-- ========================================================================================= -->
    <!-- VUE 2 : PROJET / MOIS (Manager uniquement) -->
    ...
    <!-- ========================================================================================= -->
    <!-- VUE 3 : PROJET / CONSULTANT (Manager uniquement) -->
